...
class UserAdapter(private val context: Context, private var userList:ArrayList<User>, val onIteamClickUser: OnItemClickUser):RecyclerView.Adapter<UserAdapter.ViewHolder>() {
